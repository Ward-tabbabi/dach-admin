  ...
  return (
    <div className="userdash">
      ...
      <div className="userlist">
        <h1>the list of all users in this week</h1>
        <ul>
          <li>user n:1</li>
          <li>user n:2</li>
          <li>user n:3</li>
        ...
        <div className="graphcontainer">
          <div class="frame">
            <h1> Weekly list of useres</h1>
            <div class="card">
              <div class="header">
                <span class="title big">users/days</span>
                <span class="date small">01. Feb - 07. Feb</span>
                <span class="type small">user-graph</span>
                <span class="value">all-users</span>
              </div>
              <div class="clearfix"></div>
              <div class="parameter">
                <span class="red">Views</span>
                <span class="blue">use</span>
              </div>
              <div class="statistic">
